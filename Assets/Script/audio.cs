    ...
    private void FixedUpdate()
        {
            ...
            if (m_StartedSound)
            {
                ...
                float pitch = ULerp(lowPitchMin, lowPitchMax, m_CarControl.engineRPM / m_CarControl.maxRPM);
                ...
                // get values for fading the sounds based on the acceleration
                    ...
                    accFade = Mathf.Abs((inputManager.vertical > 0 && !m_CarControl.test ) ?inputManager.vertical : 0);

                    float decFade = 1 - accFade;

                    // get the high fade value based on the cars revs
                    float highFade = Mathf.InverseLerp(0.2f, 0.8f,  m_CarControl.engineRPM / 10000);
